...
import { getSingleUser } from "../store/slices/Users_Slice"; // Import giveDonation action
import { giveDonation, resetSuccess } from "../store/slices/Donation_Slice";
...
const Give_Donation = () => {
  ...
  const { error, success } = useSelector((state) => state.donations);
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-7">
                    <div>
                      ...
                      <p className="text-sm text-neutral-50">
                        Keep your name as one to appear in the top supporter
                        list (e.g., if you have super chatted with Bilal first,
                        then don&apos;t change this name to Bilal1 or anything
                        else keep the exact name).
                      </p>
                    </div>
                    <div>
                      <Label
